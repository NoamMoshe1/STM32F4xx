...
void loop() 
{
  ...
  i = 0;
  dataLen = SPI_SlaveReceive();c:\Git\Mastering Microcontroller and Embedded Driver Development\Resources\Arduino\spi\002SPISlaveCmdHandling\002SPISlaveCmdHandling.ino
  for(i = 0 ; i < dataLen ; i++ )
  {
